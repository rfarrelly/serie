...
from app.metrics import LeagueMetrics, TeamMetrics
...
def test_season_metrics_computes_metrics_tables(schedule_df: pd.DataFrame):
    team_metrics = TeamMetrics(
        ...
        matches=pd.read_csv(
            "DATA/FBREF/National-League/National-League_2025-2026.csv"
        ).copy(),
    ...
    latest_points_performance_index_normalised = (
        team_metrics.latest_points_performance_index_normalised
    )
